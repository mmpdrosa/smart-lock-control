...
const char* password = "1la2sec3";

String serverUrl = "https://smart-lock-control.vercel.app";

String lastQRCodeResult = String("");
...
/* ________________________________________________________________________________ My loop code */

void loop() {
  if(WiFi.status()== WL_CONNECTED){
    if (lastQRCodeResult != String(QRCodeResult)){
        
        Serial.print("Código reconhecido: ");
        Serial.println(QRCodeResult);
        lastQRCodeResult = QRCodeResult;

        HTTPClient http;
        String serverPath = serverUrl + "/api/lock/keys?code=" + QRCodeResult;
        http.begin(serverPath.c_str());
        int httpResponseCode = http.PATCH("");  
        if (httpResponseCode == 200) Serial.println("Autorizado");
...
/* ________________________________________________________________________________ End my loop code */
